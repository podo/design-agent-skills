...
2. **Which agent?**
   - Claude Code / Cursor → `npx skills add Community-Access/accessibility-agents` — or send `! npx skills add … -g` as a chat message to install without leaving the conversation
