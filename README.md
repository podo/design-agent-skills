...
Stubs live in `skills/<skill-name>/SKILL.md`. They are **not** full skills — they are lightweight adapters that:
...
4. Open a PR — no review of the upstream skill content required, only the stub structure

## Skills in this catalogue

| Skill | Category | Upstream |
|-------|----------|----------|
| [taste-skill](skills/taste-skill/SKILL.md) | design-systems | [Leonxlnx/taste-skill](https://github.com/Leonxlnx/taste-skill) |
